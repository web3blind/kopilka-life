...
const ARTIFACTS = [
  ...
  {
    id: 'contract_keeper',
    title: 'Черепаха Тихого Договора',
    shortTitle: 'Четыре недели пути',
    triggerText: 'появляется после четырёх выполненных недельных договоров',
    unlockedText: 'Черепаха Тихого Договора медленно вышла навстречу. На её панцире зажглись четыре тёплых знака — по одному за каждую неделю, где договор с собой стал поддержкой, а не наказанием.',
    lockedText: 'Она приходит к тем, кто несколько недель возвращался к договору с собой и доводил его до результата.',
    image: '/assets/artifacts/contract_keeper.webp',
    alt: 'Милая зелёная черепаха с добрыми глазами; на панцире четыре светлых знака выполненных недель.',
    sortOrder: 49,
