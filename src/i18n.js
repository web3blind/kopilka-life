...
const DAILY_HINTS = [
  ...
  { id: 'gratitude', title: { ru: 'Одна благодарность', en: 'One gratitude note' }, text: { ru: 'Можно коротко вспомнить, кому или чему ты сегодня благодарен: человеку, дню, телу, случаю, месту или себе.', en: 'You can briefly notice who or what you are grateful to today: a person, the day, your body, an event, a place, or yourself.' }, action: { ru: 'Запиши одну короткую благодарность, если хочется.', en: 'Write one short gratitude note, if you want.' } },
