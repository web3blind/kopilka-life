...
const STRINGS = {
  ...
  'entry.dream_step.hint': { ru: 'маленькое действие к цели', en: 'small step toward a goal' },
  'entry.kind_trace.title': { ru: 'Доброе дело', en: 'Kind deed' },
  'entry.kind_trace.hint': { ru: 'помощь, спасибо, тёплое слово', en: 'help, thanks, a warm word' },
  'entry.honest_step.title': { ru: 'Честный шаг', en: 'Honest step' },
  'entry.honest_step.hint': { ru: 'признал, исправил, закрыл мелочь', en: 'admitted, fixed, closed a small thing' },
...
const DAILY_HINTS = [
  ...
  { id: 'soft-contract', title: { ru: 'Упрости договор', en: 'Simplify the contract' }, text: { ru: 'Хороший недельный договор звучит как “5 из 7”, а не как “всегда”.', en: 'A good weekly contract sounds like “5 of 7”, not “always”.' }, action: { ru: 'Если цель давит, сделай её мягче.', en: 'If the goal feels heavy, make it gentler.' } },
