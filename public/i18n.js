...
(function (global) {
  ...
  const STRINGS = {
    ...
    vkOauthNotConfigured: { ru: 'Вход через VK ID на сайте ещё настраивается: нужен отдельный VK ID OAuth client ID.', en: 'VK ID sign-in on the site is still being configured: a separate VK ID OAuth client ID is required.' },
