...
(function (global) {
  ...
  const STRINGS = {
    ...
    gratitudePracticeQuestion: { ru: 'Кому или чему ты сегодня благодарен?', en: 'Who or what are you grateful to today?' },
    gratitudeNoteLabel: { ru: 'Короткая благодарность', en: 'Short gratitude note' },
    gratitudeNotePlaceholder: { ru: 'Например: дню — за тишину', en: 'Example: to the day — for quiet' },
    gratitudeNoteHint: { ru: 'Это может быть благодарность человеку, дню, телу, случаю, месту или себе.', en: 'It can be gratitude to a person, the day, your body, an event, a place, or yourself.' },
    gratitudeHintsSummary: { ru: 'Подсказки', en: 'Hints' },
    gratitudeHintParents: { ru: 'родителям — за жизнь', en: 'my parents — for life' },
    gratitudeHintDay: { ru: 'дню — за то, что он такой', en: 'the day — for being what it is' },
    gratitudeHintPerson: { ru: 'человеку — за поддержку', en: 'a person — for support' },
    gratitudeHintBody: { ru: 'телу — за силы', en: 'my body — for strength' },
    gratitudeHintSelf: { ru: 'себе — за честность', en: 'myself — for honesty' },
