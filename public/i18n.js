...
(function (global) {
  ...
  const STRINGS = {
    ...
    artifactsIntro: { ru: 'На пути иногда появляются персонажи. Они приходят не только за очки, но и за живые действия.', en: 'Characters sometimes appear on the path. They come not only for points, but for real actions.' },
