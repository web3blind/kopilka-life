...
('vk-author-page', 'Открыть личную страницу автора', 'Там больше про разработку, доступность, ИИ-агентов и путь проекта от Дениса.', 'Открыть и засчитать', 'https://vk.com/blind_dev', 'vk', 'open_url', 1, 0, 0, NULL, 1, 25, '2026-08-23 12:04:00');
