...
('telegram-channel', 'Открыть Telegram Копилки', 'Там короткие заметки про ИИ-агентов, доступность и работу над проектами. Подписка поможет не потерять обновления.', 'Открыть и засчитать', 'https://t.me/HarborLifeBot', 'telegram', 'open_url', 1, 0, 0, NULL, 1, 30, '2026-08-23 12:03:00'),
('vk-community', 'Открыть VK-сообщество', 'Там будут новости Копилки и спокойные обновления. Ваша подписка и реакции помогут проекту стать заметнее.', 'Открыть и засчитать', 'https://vk.com/life_harbor_game', 'vk', 'open_url', 1, 0, 0, NULL, 1, 20, '2026-08-23 12:02:00'),
('share-kopilka', 'Поделиться Копилкой', 'Отправьте ссылку человеку, которому может подойти мягкое приложение про жизнь и заботу. Он получит простой способ отмечать день, а проект — шанс найти своего пользователя.', 'Открыть и засчитать', 'https://life.blinddev.xyz', 'web', 'open_url', 1, 0, 0, NULL, 1, 10, '2026-08-23 12:01:00');
